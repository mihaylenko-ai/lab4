...
соседей зададим мгновенное время реакции на изменение топологии, а так же включим протокол BFD, для более точного отслеживания проблем на каналах связи между утсройствами.
