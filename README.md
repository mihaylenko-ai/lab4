...
В качестве описания настроек будем использовать группы параметров. Типовые настройки каждого устройства автономной системы сведем к уменьшению таймеров исходя из соотношения
